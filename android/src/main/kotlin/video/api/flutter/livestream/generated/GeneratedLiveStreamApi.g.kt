...
interface LiveStreamHostApi {
  ...
  fun getSensorOrientation(cameraId: String): Long
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: LiveStreamHostApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.apivideo_live_stream.LiveStreamHostApi.getSensorOrientation$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val cameraIdArg = args[0] as String
            val wrapped: List<Any?> = try {
              listOf(api.getSensorOrientation(cameraIdArg))
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.apivideo_live_stream.LiveStreamHostApi.isPreviewPreTransformed$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
...
interface DeviceOrientationManagerHostApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: DeviceOrientationManagerHostApi?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.apivideo_live_stream.DeviceOrientationManagerHostApi.getUiOrientation$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
